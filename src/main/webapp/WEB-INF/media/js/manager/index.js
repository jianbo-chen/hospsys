...
$(function () {
    ...
    $("#logout").click(function(){
        ...
        if(bool == true){
            $.ajax({
                url:"/user/adminLogout.do",
                dataType:"json",
                success:function(data){
                    var json=data;
                    alert(json["msg"]);
                    window.location.href="/go/manager/login";
                }
            })
        }
    })
    ...
    //获取登录管理员
    $.ajax({
        url:"/user/getLoginAdmin.do",
        dataType:"json",
        success:function(data){
            var json=data;
           $("span#loginUser").html(json["data"].userName);
           $("img#userPhoto").attr('src','/media/image/'+json["data"].userPhoto);
        }
    })
})